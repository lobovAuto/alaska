...
"""Запись корректного медведя гамми"""
@pytest.mark.post_correct_data
def test_post_correct_data_polar(bare_alaska, post_bear_addr, test_param_fixt, test_answ_fixt):
    ...
    assert response.json() == [test_answ], f"Запись медведя типа GUMMY не сработала"
